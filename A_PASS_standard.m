...
s.hf = figure('toolbar','figure','menubar','none','numbertitle','off',...
    'name','A-PASS','units','normalized','position',[0.1 0.1 0.4 0.8]);
...
s.MRc_check = uicontrol('parent',s.hf,'style','checkbox','string','MR artifact correction','FontSize',12,'units','normalized',...
    'position',[0.1 0.65 0.3 0.03],'Value',1);
s.BCGc_check = uicontrol('parent',s.hf,'style','checkbox','string','BCG artifact correction','FontSize',12,'units','normalized',...
    'position',[0.1 0.6 0.3 0.03],'Value',1);
s.score_check = uicontrol('parent',s.hf,'style','checkbox','string','Sleep scoring','FontSize',12,'units','normalized',...
    'position',[0.1 0.55 0.3 0.03],'Value',1);
s.manualscore_check = uicontrol('parent',s.hf,'style','checkbox','string','Manual check for stages','FontSize',12,'units','normalized',...
    'position',[0.1 0.5 0.3 0.03]);
...
s.save_button = uicontrol('Parent',s.hf,'Style','pushbutton','String','Save','FontSize',12,'Units','normalized',...
    'Position',[0.55 0.05 0.1 0.03]);
s.load_button = uicontrol('Parent',s.hf,'Style','pushbutton','String','Load','FontSize',12,'Units','normalized',...
    'Position',[0.65 0.05 0.1 0.03]);
s.run_button = uicontrol('Parent',s.hf,'Style','pushbutton','String','Run','FontSize',15,'FontWeight','bold','Units','normalized',...
