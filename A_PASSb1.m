...
s.eegpre_check = uicontrol('Parent',s.hf,'Style','checkbox','String','EEG preprocessing','FontSize',12,'Units','normalized',...
    'Position',[0.08 0.7 0.23 0.03],'Value',1);
...
s.score_check = uicontrol('parent',s.hf,'style','checkbox','string','Sleep scoring','FontSize',12,'units','normalized',...
    'position',[0.67 0.65 0.2 0.03],'Value',1);

s.manualscore_check = uicontrol('parent',s.hf,'style','checkbox','string','Manual check for stages','FontSize',12,'units','normalized',...
    'position',[0.08 0.58 0.3 0.03]);


s.fMRI_frame = uicontrol('Parent',s.hf,'Style','frame','Units','normalized','Position',[0.1, 0.22 0.82 0.32]);
...
s.fmriproc_check = uicontrol('parent',s.hf,'style','checkbox','string','fMRI processing','FontSize',12,'units','normalized',...
    'position',[0.08 0.53 0.2 0.03],'Value',1);
