...
scans.name    = 'Scans';
scans.help    = {' '
    'Select the images (".gii", ".img", ".nii", ".dtseries.nii" or "dscalar.nii") or a single ".mat" object containing the matrix of data with the scans in rows.'
...
WB_img         = cfg_const;
WB_img.tag     = 'WB_img';
WB_img.name    = 'img/nii/gii/dtseries.nii/dscalar.nii input';
WB_img.val     = {0};
WB_img.help    = {''
  'Clusterwise inference will be performed on image input given as image/nifti/gifti/cifti files.'
  ''};
