...
switch lower(varargin{1})
    ...
    %======================================================================
        ...
        nname  = inputdlg(str,'SwE: Rename contrast',1,{xCon(I).name},'off');
    ...
    %======================================================================
        % [c,I,emsg,imsg,msg] = swe_conman('ParseCon',cstr,X,STAT)
    ...
    %======================================================================
        % [iX0,I,emsg,imsg] = swe_conman('ParseIStr',str,max)
    ...
    %======================================================================
        ...
        SwE     = get(gcf,'UserData');
        xCon = SwE.xCon;
        STAT     = get(findobj(gcbf,'Tag','TFA','Value',1),'UserData');

        swe_conman('ListCon',hConList,xCon,STAT,[])


    %======================================================================
    case 'd_setup_cb'
    %======================================================================
        % swe_conman('D_Setup_CB')
        ...
        swe_conman('D_TF',F,STAT,STATmode);       %-Setup rest of define UI


    %======================================================================
    case {'d_conmtx_cb','d_x1cols_cb'}
    %======================================================================
        % swe_conman('D_ConMtx_CB')
        % swe_conman('D_X1cols_CB')
        ...
        %------------------------------------------------------------------
            ...
            nPar              = spm_SpUtil('size',xX.X,2);
            [iX0,I,emsg,imsg] = swe_conman('ParseIStr',str,nPar);

            if I
                try %-try-catch block for any errors in spm_FcUtil!
                    DxCon = spm_FcUtil('Set','',STAT,'iX0',iX0,xX.X);
        ...
        if all(I)
            ...
            swe_conman('GraphCons',DxCon,-1,F)      %-Depict contrast
        else
    ...
    %======================================================================
        ...
        swe_conman('TFA',F,xCon(end).STAT);                     %-Set STAT
        swe_conman('ListCon',hConList,xCon,xCon(end).STAT,I)    %-ListCon
    ...
    %======================================================================
        ...
        F = figure('IntegerHandle','off',...
            'Tag','ConMan',...
            'Name','SwE contrast manager','NumberTitle','off',...
        ...
        hT = uicontrol(F,'Style','RadioButton','String','t-contrasts','Tag','TFA',...
            'ToolTipString','...to show only contrasts for SwE{t}',...
            'FontSize',FS(9),...
            'ForegroundColor','k',...
            'UserData','T',...
            'Position',[044 343 105 020].*WS);
        hF = uicontrol(F,'Style','RadioButton','String','F-contrasts','Tag','TFA',...
            'ToolTipString','...to show only contrasts for SwE{F}',...
            'FontSize',FS(9),...
            'ForegroundColor','k',...
            'UserData','F',...
        ...
        set([hT,hF,hA],'CallBack','swe_conman(''TFA'');',...
        ...
        hNew = uicontrol(F,'Style','Pushbutton','String','Define new contrast...',...
            ...
            'ForegroundColor','b',...
            'Callback','swe_conman(''D_Setup_CB'')',...
            'Enable','on',...
        ...
        uimenu(h,'Label','help','Separator','on',...
            'CallBack','spm_help(''swe_conman'')',...
            'Interruptible','off','BusyAction','Cancel');
        uimenu(h,'Label','crash out','Separator','on',...
            'CallBack','swe_conman(''Initialise'',''reset'');',...
            'Interruptible','off','BusyAction','Cancel');
        set(h,'CallBack','swe_conman(''FConMenu_CB'')',...
            'Interruptible','off','BusyAction','Cancel');
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_name',...
            ...
            'Callback','swe_conman(''D_Status'')','Interruptible','off',...
        ...
        hDT = uicontrol(F,'Style','RadioButton','String','t-contrast','Tag','D_TF',...
            'ToolTipString','...to define contrast for SwE{t}',...
            'FontSize',FS(9),...
            'ForegroundColor','k',...
            'UserData','T',...
            'Position',[080 300 105 022].*WS);
        hDF = uicontrol(F,'Style','RadioButton','String','F-contrast','Tag','D_TF',...
            'ToolTipString','...to define contrast for SwE{F}',...
            'FontSize',FS(9),...
            'ForegroundColor','k',...
            'UserData','F',...
            'Position',[190 300 105 022].*WS);
        set([hDT,hDF],'CallBack','swe_conman(''D_TF'');',...
            'Interruptible','off','BusyAction','Queue')
        H = [H,hDT,hDF];
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_ConMtx',...
            ...
            'BackgroundColor',COLOUR,...
            'Max',2,...
            'CallBack','swe_conman(''D_ConMtx_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
            'UserData',[],...
        ...
        h = uicontrol(F,'Style','Edit','Tag','D_X1cols',...
            ...
            'HorizontalAlignment','Left',...
            'BackgroundColor',COLOUR,...
            'CallBack','swe_conman(''D_X1cols_CB'')',...
            'Interruptible','off','BusyAction','Queue',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Reset',...
            ...
            'ForegroundColor','b',...
            'Callback','swe_conman(''D_Reset_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
        ...
        h = uicontrol(F,'Style','Pushbutton','String','Cancel',...
            ...
            'ForegroundColor','r',...
            'Callback','swe_conman(''D_Cancel_CB'')',...
            'Interruptible','off','BusyAction','Cancel',...
