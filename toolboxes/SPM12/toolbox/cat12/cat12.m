...
% $Id: cat12.m 1722 2020-10-02 10:11:40Z gaser $
...
h03 = uicontrol(...
  ...
  'FontName',get(0,'defaultuicontrolFontName'));
    ...
    if expert
      ...
      'UserData',{...
        'spm_jobman(''interactive'','''',''spm.tools.cat.estwrite'');'...
        ...'spm_jobman(''interactive'','''',''spm.tools.previous.cat.estwrite1585'');'...
        'spm_jobman(''interactive'','''',''spm.tools.cat.previous.estwrite1445'');'...
        'spm_jobman(''interactive'','''',''spm.tools.cat.previous.estwrite1173'');'...
      });
    else
        set(h03,...  
      'Style','pushbutton',...
...
h04 = uicontrol(...
  ...
  if expert
    set(h04,...  
      ...
      'UserData',{...
        'spm_jobman(''interactive'','''',''spm.tools.cat.long'');'...
        'spm_jobman(''interactive'','''',''spm.tools.cat.previouslong.long1445'');'...
        'spm_jobman(''interactive'','''',''spm.tools.cat.previouslong.long1173'');'...
      });
  else
    set(h04,...  
      'Style','pushbutton',...
