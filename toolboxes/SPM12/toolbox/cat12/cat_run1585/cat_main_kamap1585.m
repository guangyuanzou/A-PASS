function [P,res,stime2] = cat_main_kamap1585(Ysrc,Ycls,Yy,tpm,job,res,vx_vol,stime2)
...
%
%   [P,res,stime2] = cat_main_amap1585(Ysrc,Ycls,job,res,stime2)
%
...
% University Jena 
% ______________________________________________________________________
% $Id: cat_main_kamap1585.m 1741 2020-12-11 13:51:55Z gaser $ 
...
% ______________________________________________________________________
  ...
  Yi(Yb==0) = T3th(5);
  Yi   = cat_vol_approx1585(Yi,'nn',vx_vol,4); 
